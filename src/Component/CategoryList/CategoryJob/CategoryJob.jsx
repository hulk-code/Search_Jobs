...
const CategoryJob = ({categoryJob}) => {
    ...
    return (
        <div className='bg-slate-50 p-5 hover:bg-amber-50
         hover:scale-105 hover:shadow-lg hover:shadow-sky-500 
         transition-all duration-300 ease-in-out rounded-lg m-5'>
        <img src={accounts} alt="" className='transition-transform duration-300 ease-in-out hover:scale-110' />
        <h1 className='text-gray-800 hover:text-red-400 font-bold'>{category_name}</h1>
